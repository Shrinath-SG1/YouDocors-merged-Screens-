  ...
  Widget build(BuildContext context) {
    ...
    Widget _portrait() {
      ...
      return BlocListener<PinScreenGenerateBloc,PinGenerateScreenState>(
        ...
        child: buildListView(height, width, StoredPin, context,/* MemberId,*/ pinPutDecoration),
      );
    }
    Widget _landScape() {
      ...
      return BlocListener<PinScreenGenerateBloc,PinGenerateScreenState>(
        ...
        child: buildListView(height, width, StoredPin, context,  pinPutDecoration),
      );
    }
...
return _landScape();
  ...
  ListView buildListView(double height, double width, String StoredPin, BuildContext context, BoxDecoration pinPutDecoration) {
    return ListView(
        children: [
          Stack(
          children: [
                          ...
                          child: PinPut(
                            ...
                            onSubmit: (String pin) {
                              ...
                              if (pin == StoredPin) {
                                ...
                                BlocProvider.of<PinScreenGenerateBloc>(context).add(PinGenerateScreenEvent(pin, Generate,int.parse(widget.data2)));
                                // Navigator.push(context, MaterialPageRoute(builder: (context)=>Welcome()));

                              } else {
                               // _showSnackBar('Pin Not Matched!!');
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>CreatePinScreen(data: widget.data2,)));
